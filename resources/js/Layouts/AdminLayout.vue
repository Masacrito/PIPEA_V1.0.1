...
const menu = [
    {
        seccion: 'Principal',
        items: [
            { label: 'Dashboard', ruta: 'admin.dashboard', icono: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', roles: ['SUPER_ADMIN', 'ADMIN_DEPENDENCIA'] },
        ],
    },
    {
        seccion: 'Catálogos PI-PEA',
        items: [
            { label: 'Ejes',        ruta: 'admin.catalogos.ejes.index',        icono: 'M4 6h16M4 10h16M4 14h16M4 18h16',                                                                                                                                                         roles: ['SUPER_ADMIN', 'ADMIN_DEPENDENCIA'] },
            { label: 'Objetivos',   ruta: 'admin.catalogos.objetivos.index',   icono: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2',                                                      roles: ['SUPER_ADMIN', 'ADMIN_DEPENDENCIA'] },
            { label: 'Prioridades', ruta: 'admin.catalogos.prioridades.index', icono: 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z', roles: ['SUPER_ADMIN', 'ADMIN_DEPENDENCIA'] },
            { label: 'Estrategias', ruta: 'admin.catalogos.estrategias.index', icono: 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7',                    roles: ['SUPER_ADMIN', 'ADMIN_DEPENDENCIA'] },
            { label: 'Plazos',      ruta: 'admin.catalogos.plazos.index',      icono: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z',                                                                                               roles: ['SUPER_ADMIN', 'ADMIN_DEPENDENCIA'] },
            { label: 'Frecuencias', ruta: 'admin.catalogos.frecuencias.index', icono: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z',                                                                                                                                             roles: ['SUPER_ADMIN', 'ADMIN_DEPENDENCIA'] },
        ],
    },
    {
        seccion: 'Gestión',
        items: [
            { label: 'Organismos', ruta: 'admin.organismos.index', icono: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4', roles: ['SUPER_ADMIN', 'ADMIN_DEPENDENCIA'] },
            { label: 'Usuarios',   ruta: 'admin.usuarios.index',   icono: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z',                                  roles: ['SUPER_ADMIN', 'ADMIN_DEPENDENCIA'] },
        ],
    },
    {
        seccion: 'Sistema',
        items: [
            { label: 'Roles y permisos', ruta: 'admin.roles.index', icono: 'M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z', roles: ['SUPER_ADMIN'] },
            { label: 'Logs auditoría',   ruta: 'admin.logs.index',  icono: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01', roles: ['SUPER_ADMIN'] },
        ],
    },
]
...
const menuFiltrado = computed(() =>
    menu
        .map(s => ({ ...s, items: s.items.filter(i => i.roles.includes(rol.value)) }))
...
.banner-title { font-family: var(--font-display); font-size: 0.95rem; font-weight: 700; color: var(--color-vino); letter-spacing: 0.02em; white-space: nowrap; }
