...
const tarjetas = computed(() => [
    {
        ...
        valor: props.stats.organismos,
        ico:   'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4',
        color: 'verde',
    },
    {
        label: 'Usuarios activos',
        valor: props.stats.usuarios,
    ...
    {
        label: 'Avance general PI-PEA',
        valor: `${props.stats.avance}%`,
...
// Accesos rápidos — solo se muestran si la ruta existe en Ziggy
const safeRoute = (name) => { try { return route(name) } catch { return null } }

const accesos = computed(() => [
    {
        label: 'Catálogos PI-PEA',
        sub:   'Ejes del PI-PEA',
        color: 'verde',
        ruta:  safeRoute('admin.catalogos.ejes.index'),
        ico:   'M4 6h16M4 10h16M4 14h16M4 18h16',
    },
    {
        label: 'Organismos implementadores',
        sub:   'Alta y gestión de dependencias',
        color: 'vino',
        ruta:  safeRoute('admin.organismos.index'),
        ico:   'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5',
    },
    {
        label: 'Usuarios del sistema',
        sub:   'Crear y administrar cuentas',
        color: 'magenta',
        ruta:  safeRoute('admin.usuarios.index'),
        ico:   'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197',
    },
    ...
    <AdminLayout>
        <div class="dash">
            ...
            <div class="dash-head">
                ...
                <span :class="['badge-rol', `badge-rol--${rol?.toLowerCase()}`]">
                    {{ rolLabel }}
                </span>
            </div>
            ...
            <div class="dash-body">
                ...
                <div class="dash-panel">
                    ...
                    <div v-else class="quick-list">
                        <Link
                            v-for="a in accesos" :key="a.label"
                            :href="a.ruta"
                            class="quick-item"
                        >
